...
#----- note ------------
#
# this is https://github.com/orcasgit/python-fitbit/blob/master/gather_keys_oauth2.py
# included here just-in-case the upstream URL changes
#  (many thanks to the original author)
#
#  this is version 0.3.0 last edited in Jan 2017
#
#----- end note ----
